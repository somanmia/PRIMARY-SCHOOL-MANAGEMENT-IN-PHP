...
if(isset($_REQUEST['stuid'])){
    $id=$_REQUEST['stuid'];
    $sql="SELECT * FROM class_1 WHERE id=$id";
...
<?php
        ...
        if(isset($_REQUEST['submit'])){
              ...
              $sql="UPDATE class_1 SET Exm_year=$year,Bangla=$bangla,English=$english,Math=$math WHERE id= $id";
              $run=mysqli_query($connect,$sql);
              if($run==true){
       ...
       <div class="container">
          <div class="row">
             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="primary-result-upload-title">
                <h5 class="text-center mb-4">RESULT UPDATE CLASS I</h5>
