...
<?php
 ...
 if(isset($_REQUEST['submit'])){
    ...
    if($year==""){
       ...
       $sql="SELECT Exam_Year From psc where Exam_Year=$year";
    ...
    if($ck==0){
           $sql="INSERT INTO psc(Exam_Year, Total_Student, Passed, Fail, Gpa_5, Gpa_4) 
            VALUES
...
?>
    <section>
       <div class="container">
          <div class="row">
             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="psc-upload-title">
                <h5 class="text-center mb-4 text-success">PSC EXAMINATION RESULT IN  OUR SCHOOL</h5>
